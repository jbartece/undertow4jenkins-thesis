...
%                    samotné zdrojové kódy serveru, abych vše správně pochopil a využil.
    ...
    \medskip
    Kromě zde uvedených parametrů byly ostatní parametry původního servlet kontejneru zachovány a při testování
    nebyla zjištěna nefunkčnost některých z nich.
