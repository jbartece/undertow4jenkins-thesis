        ...
        \subsection{Realizace základních funkcionalit}
            ...
            \begin{enumerate}
                ...
                \item \textbf{Konfigurace webového serveru:} 
                    ...
                    Pokud uživatel specifikoval při spuštění požadavek, aby před URL adresou
                    aplikace byl nějaký řetězec (\emph{prefix}), tak je tento požadavek implementován
                ...
                \item \textbf{Vytvoření kontrolního kanálu (volitelné):} 
                    ...
                    na něm naslouchá příchozím požadavkům. Protokol, který akceptuje je popsaný
