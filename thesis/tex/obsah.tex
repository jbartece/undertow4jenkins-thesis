...
\end{priklad}
    ...
    \chapter{Implementace}  \label{kapImpl}
        ...
        %nějaké uvední do toho, oecné věci o implementaci, ve sporných místech hledání ve strých zdrojácích
...
%                    samotné zdrojové kódy serveru, abych vše správně pochopil a využil.
        ...
        %3 repozitare, zmena v jenkins CI novych verzi extra-executables-war a noveho jarka s undertow4jenkins,
        ...
        %popis toku programu - jak veci na sebe navazuji
