...
\end{priklad}
        ...
        \subsection{Způsob realizace základních funkcionalit}
    ...
    k problemům s kompatibilitou (např. při spouštění staršími skripty), tak program zadání těchto
...
\chapter{Srovnání výkonu původní a~nové implementace}  \label{kapPerformance}
    ...
    %popsat scénáře a dát do přílohy
    %popsat něco málo o frameworku na testování
