...
\end{verbatim}
    ...
    Kromě spouštění těchto testů byla aplikace opakovaně testována používáním jejich různých součástí
    a nebyly zjištěné žádné nefunkční prvky.
    Při testování výsledného programu bylo zváženo využtí integračních testů celého serveru Jenkins CI.
