            ...
            \begin{table}[ht]
             \begin{center}
              \begin{tabular}{| c || c | c | c | c | c | c |} \hline
               & \textbf{1, 2} & \textbf{2, 3} & \textbf{3, 4} & \textbf{5, 6} & \textbf{7, 8} & \textbf{9, 10} \\ \hline
                Původní verze  &  &  &  &  &  &  \\ 
                 Průměrná odezva [ms] & 3.096 & 3,100 & 3,096 & 3,099 & 3,113 & 3,102 \\ \hline
                Nová verze &  &  &  &  &  &  \\ 
                 Průměrná odezva [ms] & 1,433 & 1,400 & 1,465 & 1,399 & 1,417 & 1,399 \\ \hline
              \end{tabular}
              \caption{Tabulka}
              \label{tab}
             \end{center}
