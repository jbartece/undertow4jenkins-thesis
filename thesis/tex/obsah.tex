...
\chapter{Implementace}  \label{kapImpl}
 IN PROGRESS
    ...
    \section{Základní informace}
        ...
        program Maven. Z důvodu kompatibility se serverem Jenkins CI musela být využita starší verze jazyka a to verze 6.
...
\end{priklad}
        ...
        \subsection{Realizace základních funkcionalit}
            V této kapitole jsou popsány kličové části vytvořené aplikace a způsob jakým byly implementovány. Většina těchoto
            ...
            \begin{enumerate}
                \item \textbf{Zpracování parametrů:} Jsou zkontolovány zadané parametry
                ...
                \item \textbf{Připravení načítání tříd:} Jsou vyhledány knihovny 
                    ...
                    při vyhledávání tříd specifikovaných v souboru \texttt{web.xml} a jeho instance
                    je předana serveru Undertow při inicializaci, aby bylo možné zavádět
                    potřebné součásti aplikace za běhu.

                \item \textbf{Analýza souboru web.xml:} Soubor \texttt{web.xml} je 
                    ...
                    Jenkins CI. Podpora všech možných konfigurací souboru \texttt{web.xml} je velmi rozsáhlá
                ...
                \item Nastavení pro správu uživatelských účtů a ověřování
                \item Přidání accessloggeru
                \item Přidání konektorů HTTP, AJP a HTTPS
                \item Spuštění servletu stapler
                \item Vytvoření control portu a naslouchání na něm
            \end{enumerate}
            ...
            %mapovani starych classname na nove, uzivatelske vytvareni trid,
...
\chapter{Srovnání výkonu původní a~nové implementace}  \label{kapPerformance}
    ...
    %kontroluje i kod odpovedi 200 je ok
    %zrychleni cele aplikace merime, ale cast zpozdeni je dana samotnou aplikaci,
    %takze zrychleni cinnosti servlet kontejneru je urcite vetsi nez ta procenta co vyjdou
