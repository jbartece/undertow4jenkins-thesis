...
\chapter{Úvod}
    ...
    kontinuální integrace softwaru. Vylepšení se týká především webového serveru a~\emph{servlet kontejneru}, který je v~Jenkins CI integrován. 
    ...
    Následně je detailně analyzována architektura Jenkins CI a~způsob jeho integrace se servery Winstone a~Jetty. 
    ...
    Poslední část této práce je věnována zhodnocení výkonu původní a~upravené verze serveru Jenkins CI. Výkon
...
\chapter{Závěr}
    ...
    %provedena implementace

    %testování výkonu
    %získané zrychlení
    %plně funkční a neobjeveny žádné problémy se zpětnou kompatibilitou
    %bude předloženo komunitě Jenkins CI
    %další vývoj: přidání podpory SPDY až bude přidána do Undertow, 
    %zpracování zbytku web.xml?
