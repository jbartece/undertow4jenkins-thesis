...
\chapter{Jenkins CI a~související nástroje}
    ...
    a~Apache\footnote{Licence Apache je dostupná 
        ...
        %TODO nějaké reference na ty tachnologie, možná popsat SPDY
    ...
    \section{Server Undertow} \label{undertow}
        ...
        %TODO V budoucnu rozšířit - jít více do hloubky principu na kterých Undertow pracuje
        %zpusob jak je vystaven, jak pracuje, implementace servlet kontejneru, security veci,
        %handler chainy 
        ...
        \subsection{Srovnání serverů Undertow a~Jetty}\label{srovnani}
            ...
            \begin{itemize}
                ...
                \item{\textbf{Rychlost spuštění:}  Velmi často je u~serverů hodnocena hlavně
                    ...
                    %TODO potřeba zvážit, ale není to klíčové
                ...
                %TODO 
                %Zvážit kam napsat o chybějící pořádné doku k Undertow
