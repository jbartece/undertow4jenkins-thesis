...
\chapter{Úvod}
    ...
    Nedávno vznikl nový webový server Undertow, který si klade za cíl být co nejjednodušší a~nejrychlejší. Mohl by být přínosný
    a~vhodný pro Jenkins CI. Vzhledem k tomu, že je tento server a~je sponzorován firmou Red Hat, tak lze předpokládat, že jeho vývoj
    ...
    a~výsledku celé integrace je v
    závěru této práce zhodnocen její přínos pro komunitu projektu Jenkins CI.
...
\chapter{Závěr}
    ...
    dodělána podpory komunikace pomocí protokolu SPDY, 
