        ...
        \subsection{Realizace základních funkcionalit}
            ...
            \begin{enumerate}
                ...
                \item \textbf{Nastavení servlet kontejneru v Undertow:} V tomto kroku
                    ...
                    a spuštění Jenkins CI. Nejprve jsou všechny načtené konfigurace ze souboru \texttt{web.xml}
                    nastaveny v třídě \texttt{DeploymentInfo}, která reprezentuje data pro vytvoření servlet
                    kontejneru. Při konfiguracích jsou načítány třídy z archivu aplikace pomocí zavaděče vyvořeného
                    ...
                    Pro správu a statických zdrojů Jenkins CI je vytvořena instance třídy \\\texttt{FileResourceManager}
                ...
                \item \textbf{Nastavení správy uživatelských účtů:}
                
                \item \textbf{Nastavení zaznamnávání příchozích požadavků:} accesslogger implementovany jako handler na konci retezce handleru,    
                
                \item \textbf{Konfigurace webového serveru:} Přidání konektorů HTTP, AJP a HTTPS
                    %pridavani prefixu k url adrese - vyreseno pridanim RedirectHandleru na zacatek weboveho serveru
                
                \item \textbf{Vytvoření kontrolního kanálu:} control port a naslouchání na něm, implementace kontrol portu,
