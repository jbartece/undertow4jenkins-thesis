...
\chapter{Analýza současného stavu servlet kontejneru a~návrh integrace}
    ...
    \section{Zpětná kompatibilita servlet kontejner v~Jenkins CI}   \label{secKompatibilita}
        ...
        \subsection{Zabezpečení v~Jenkins CI} \label{secSecurityArchitecture}
            ...
            Jenkins CI samostatně, ale pro provádění autentizace poskytuje několik možností:

            \begin{itemize}
                \item Delegovat autentizaci na servlet kontejner
                \item Využít vlastní databázi uživatelů sefinovanou v Jenkins CI
                \item Získávat informace o uživatelích z LDAP serveru
                \item Delegovat autentizaci na databázi uživatelů v operačním systému UNIX. Uživatelé 
                    se mohou přihlásit zadáním jejich přístupovch práv do ooperačního systému. 
            \end{itemize}
            
            Servlet kontejner musí poskytovat možnost autentizace pro Jenkins CI a poskytnout podporu
            ...
            \begin{itemize}
                \item \emph{security-role} popsat
                \item \emph{security-constraint} 
                \item \emph{login-config}
            \end{itemize}
            ...
            dva druhy realm classes, autentizace, definování uživatelů, obrázek autentizace
                  % \cite{securityArchitectureWinstone}
