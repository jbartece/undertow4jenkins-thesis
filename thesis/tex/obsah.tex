...
\end{verbatim}
    ...
    \section{Server Undertow} \label{undertow}
        ...
        Informace v~této kapitole byly čerpány především z~webové dokumentace projektu \cite{undertowDocs},
        ...
        \subsection{Architektura serveru}
            %jít více do hloubky principu na kterých Undertow pracuje
            ...
            \subsubsection{Webový server}
                ...
                %zpusob jak je vystaven, jak pracuje, 
                %listenery i all interfaces 0.0.0.0, handlery, handler chain, preddefinované
                ...
                %ukazka kousku kodu s vytvoreni serveru
            ...
            \subsection{Zabezpečení servlet kontejneru}
