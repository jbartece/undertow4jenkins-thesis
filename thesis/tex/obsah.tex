...
\chapter{Jenkins CI a~související nástroje} \label{kapJenkins}
    ...
    \section{Webový server a~servlet kontejner} \label{servletWebserver}
        ...
        \subsection{Servlet kontejner} \label{servletKontejner}
            ...
            třídu, ze~které jsou při zpracovávání požadavků vytvářeny její instance. Po obdržení nějakého
...
\chapter{Implementace}  \label{kapImpl}
    ...
    Následně jsou zmíněny hlavní problémy, které se naskytly a~musely
    být řešeny (kapitola \ref{implProblemy}).
    Závěrem této kapitoly je blíže vymezena míra zachování zpětné kompatibility
...
\chapter{Srovnání výkonu původní a~nové implementace}  \label{kapPerformance}
    ...
    \section{Podmínky pro testování}\label{kapPodminky}
        ...
        Výsledky, které byly naměřené v~ppůběhu testování, jsou uloženy na přiloženém DVD.
    ...
    \section{Testované případy} \label{testovanePripady}
        ...
        \subsection{Popis způsobu vyhodnocování výsledků} \label{zpusobVyhodnoceniVysledku}
            ...
            V~průběhu činnosti serveru jeho doba odpovědi
            na požadavek rapidně klesá především z~těchto důvodů:
            ...
            aplikace, tak nebylo možné dosáhnout přesně stejného okamžiku. 
            ...
            oproti třem předcházejícím naměřeným hodnotám (většinou období 3 sekund).
            ...
            definováná v~rovnici \ref{eqOdchylka}, a~aritmetický průměr
        ...
        \subsection{Zobrazení hlavní stránky}
            ...
            \begin{table}[ht]
             ...
             \begin{center}
              ...
              \end{tabular}
              \caption{ Tabulka zobrazující výsledky jednotlivých běhů experimentu, kdy byla získávána hlavní stránka Jenkins CI}
            ...
            \begin{table}[h!t]
             ...
             \begin{center}
              ...
              \end{tabular}
              \caption{Tabulka shrnující výsledky celého experimentu, kdy byla získávána hlavní stránka Jenkins CI}
            ...
            Tento pokles a~stabilní stav nastával u~nové varianty serveru mírně dříve a~ze
            ...
            U~zjištěného zrychlení je důležité zdůraznit, že se jedná o~zrychlení celé aplikace, takže
        ...
        \subsection{Získání konfigurace úlohy}
            ...
            Naopak z~grafů i~hodnot směrodatné odchylky vidíme,
        ...
        \subsection{Vytvoření nové úlohy}
            ...
            tak by narůstající počet dat mohl ovlivňovat pozdější běhy testů.
            ...
            \begin{table}[ht]
             ...
             \begin{center}
              ...
              \end{tabular}
              \caption{Tabulka zobrazující výsledky jednotlivých běhů experimentu, kdy byla vytvářena nová úloha}
    ...
    \section{Zhodnocení výsledků testování} \label{kapPerfVysledky}
        ...
        V~prvních dvou případech dosáhla nová varianta lepších výsledků
    ...
    \section{Zhodnocení přínosu pro komunitu Jenkins CI} \label{kapPrinos}
        ...
        funkčně kompatibiltní se stávajícím servlet kontejnerem v~Jenkins CI, se podařilo
