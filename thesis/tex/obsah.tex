...
\chapter{Srovnání výkonu původní a~nové implementace}  \label{kapPerformance}
    ...
    \section{Testované případy} \label{testovanePripady}
        ...
        \subsection{Popis způsobu vyhodnocování výsledků} \label{zpusobVyhodnoceniVysledku}
            ...
            Tento stav byl definován jako okamžik, kdy ve třech po sobě měřených okamžicích (po 3 sekundách)
            klesne průměrná doba odezvy serveru
            o méně než $0,5\%$ (definováno v rovnici \ref{eqStabilni}).
        ...
        \subsection{Zobrazení hlavní stránky}
            ...
            \begin{table}[h!t]
             ...
             \begin{center}
              ...
              \end{tabular}
              \caption{Tabulka shrnující výsledky měřeného experimentu, které jsou zobrazeny v tabulce~\ref{tabMainPageMain}}
            ...
            Z důvodu lepší čitelnosti grafů jsou vyneseny ty experimenty, kdy byly naměřené nejlepší a nejhorší hodnoty
            ...
            což představuje zrychlení celé aplikace v průměru o $11.73\%$ (dle vztahu pro výpočet \ref{eqZrychleni}).
        ...
        \subsection{Vytvoření nové úlohy}
            Jelikož v průběhu testování tohoto scénáře na serveru vznikalo velmi velké množství úloh v Jenkins CI (řádově stovky tisíc)
            tak byla před každým spuštěním smazána domovská složka aplikace. Pokud by smazání neproběhlo,
            tak by mohly být ovlivňovány pozdější běhy testování narůstajícím množstvím dat.

        Zpomalení aplikace: 0.11 \%
    ...
    \section{Zhodnocení výsledků testování}
        ...
        zpoždění je ovlivněna samotnou implementací webové aplikace.
